...
function page() {
  ...
  return <div className=" flex flex-col items-center justify-center min-h-screen py-2">
    ...
    <h2>
      ...
      visit to ur own Prfile {data}
      </Link>}
      </h2>
      <hr />
      <button className=" bg-blue-500 mt-4 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={logout}>Logout</button>
      <button className=" bg-green-500 mt-4 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onClick={getUserData}>Get user Details</button>
  </div>;
}
